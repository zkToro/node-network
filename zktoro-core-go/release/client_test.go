...
func TestClient_GetReleaseManifestFromIPFS(t *testing.T) {
	c, err := NewClient("https://ipfs.zktoro.network", nil)
...
func TestClient_GetReleaseManifestFromDist(t *testing.T) {
	c, err := NewClient("https://invalid.zktoro.network", []string{"https://dist-dev.zktoro.network/manifests/releases"})
	assert.NoError(t, err)
...
func TestClient_GetReleaseManifestFromErr(t *testing.T) {
	c, err := NewClient("https://ipfs.zktoro.network", []string{"https://dist-dev.zktoro.network/manifests/releases"})
	assert.NoError(t, err)
