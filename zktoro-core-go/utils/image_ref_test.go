...
const testDiscoHost = "disco.zktoro.network"
...
func TestValidateDiscoImageRef(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			fixedRef:    "disco.zktoro.network/bafybeidslpugzaxfpvbhw3mknsohhdljgpqsimom6re7pbqwvtyzqtyi5m@sha256:6910b7c4806203b40bd8cd6e0d5b184280051b872517d8a37b4849a62ff9a014",
			expectedErr: nil,
		},
		{
			name:        "long default",
			ref:         "disco.zktoro.network/bafybeidslpugzaxfpvbhw3mknsohhdljgpqsimom6re7pbqwvtyzqtyi5m@sha256:6910b7c4806203b40bd8cd6e0d5b184280051b872517d8a37b4849a62ff9a014",
			fixedRef:    "disco.zktoro.network/bafybeidslpugzaxfpvbhw3mknsohhdljgpqsimom6re7pbqwvtyzqtyi5m@sha256:6910b7c4806203b40bd8cd6e0d5b184280051b872517d8a37b4849a62ff9a014",
			expectedErr: nil,
		},
		{
