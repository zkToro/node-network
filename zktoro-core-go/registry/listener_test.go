...
import (
	...
	"zktoro/zktoro-core-go/contracts/generated/contract_scanner_node_version_0_1_0"
...
func TestListener_Listen(t *testing.T) {
	...
	tests := []listenerTest{
		...
		},
		{
			...
			listener: testMumbaiListener(ctx, &ContractFilter{ZktoroStaking: true},
		...
		{
			name: "scanner-stake",
			listener: testListener(ctx, &ContractFilter{ZktoroStaking: true},
				contract_zktoro_staking_0_1_1.StakeDepositedTopic,
				Handlers{
		...
		},
		{
			...
			listener: testListener(ctx, &ContractFilter{ZktoroStaking: true},
				contract_zktoro_staking_0_1_1.TransferSingleTopic,
				Handlers{
