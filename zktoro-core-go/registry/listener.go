...
import (
	...
	"zktoro/zktoro-core-go/contracts/generated/contract_rewards_distributor_0_1_0"
	...
	"zktoro/zktoro-core-go/contracts/generated/contract_agent_registry_0_1_6"
	"zktoro/zktoro-core-go/contracts/generated/contract_dispatch_0_1_5"
	"zktoro/zktoro-core-go/contracts/generated/contract_scanner_node_version_0_1_1"
	"zktoro/zktoro-core-go/contracts/generated/contract_scanner_pool_registry_0_1_0"
	"zktoro/zktoro-core-go/contracts/generated/contract_scanner_registry_0_1_4"
	"zktoro/zktoro-core-go/contracts/generated/contract_stake_allocator_0_1_0"
	"zktoro/zktoro-core-go/contracts/generated/contract_zktoro_staking_0_1_2"
...
func (l *listener) handleZktoroStakingEvent(contracts *Contracts, le types.Log, blk *domain.Block, logger *log.Entry) error {
	...
	switch getTopic(le) {
	case contract_zktoro_staking_0_1_2.StakeDepositedTopic: // same with prev version
		evt, err := contracts.ZktoroStakingFil.ParseStakeDeposited(le)
		if err != nil {
			return err
		}
	...
	case contract_zktoro_staking_0_1_2.WithdrawalInitiatedTopic: // same with prev version
		evt, err := contracts.ZktoroStakingFil.ParseWithdrawalInitiated(le)
		if err != nil {
			return err
		}
		subjectType = evt.SubjectType
	...
	case contract_zktoro_staking_0_1_2.FrozeTopic:
		evt, err := contracts.ZktoroStakingFil.ParseFroze(le)
		if err != nil {
			return err
		}
		subjectType = evt.SubjectType
	...
	case contract_zktoro_staking_0_1_2.SlashedTopic: // same with prev version
		evt, err := contracts.ZktoroStakingFil.ParseSlashed(le)
		if err != nil {
			return err
		}
		subjectType = evt.SubjectType
	...
	case contract_zktoro_staking_0_1_2.TransferSingleTopic: // same with prev version
		evt, err := contracts.ZktoroStakingFil.ParseTransferSingle(le)
		if err != nil {
			return err
		}
	...
	case contract_zktoro_staking_0_1_2.TransferBatchTopic: // same with prev version
		evt, err := contracts.ZktoroStakingFil.ParseTransferBatch(le)
		if err != nil {
			return err
		}
...
func isUpgradeOrMigration(le types.Log) bool {
	switch getTopic(le) {
	case UpgradedTopic,
		contract_zktoro_staking_0_1_2.StakeHelpersConfiguredTopic,
...
func (l *listener) handleLog(blk *domain.Block, le types.Log) error {
	...
	if equalsAddress(le.Address, contracts.Addresses.ZktoroStaking.Hex()) {
		return l.handleZktoroStakingEvent(contracts, le, blk, logger)
	}
...
func (l *listener) setLogFilterAddrs() {
	...
	if filter != nil {
		...
		if filter.ZktoroStaking {
			addrs = append(addrs, regContracts.ZktoroStaking.Hex())
		}
