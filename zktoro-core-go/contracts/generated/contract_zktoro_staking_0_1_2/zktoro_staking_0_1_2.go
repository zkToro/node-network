...
package contract_zktoro_staking_0_1_2
...
// ZktoroStakingMetaData contains all meta data concerning the ZktoroStaking contract.
var ZktoroStakingMetaData = &bind.MetaData{
...
// ZktoroStakingABI is the input ABI used to generate the binding from.
// Deprecated: Use ZktoroStakingMetaData.ABI instead.
var ZktoroStakingABI = ZktoroStakingMetaData.ABI

// ZktoroStakingBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use ZktoroStakingMetaData.Bin instead.
var ZktoroStakingBin = ZktoroStakingMetaData.Bin

// DeployZktoroStaking deploys a new Ethereum contract, binding an instance of ZktoroStaking to it.
func DeployZktoroStaking(auth *bind.TransactOpts, backend bind.ContractBackend, _forwarder common.Address) (common.Address, *types.Transaction, *ZktoroStaking, error) {
	parsed, err := ZktoroStakingMetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ZktoroStakingBin), backend, _forwarder)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &ZktoroStaking{ZktoroStakingCaller: ZktoroStakingCaller{contract: contract}, ZktoroStakingTransactor: ZktoroStakingTransactor{contract: contract}, ZktoroStakingFilterer: ZktoroStakingFilterer{contract: contract}}, nil
}

// ZktoroStaking is an auto generated Go binding around an Ethereum contract.
type ZktoroStaking struct {
	ZktoroStakingCaller     // Read-only binding to the contract
	ZktoroStakingTransactor // Write-only binding to the contract
	ZktoroStakingFilterer   // Log filterer for contract events
}

// ZktoroStakingCaller is an auto generated read-only Go binding around an Ethereum contract.
type ZktoroStakingCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ZktoroStakingTransactor is an auto generated write-only Go binding around an Ethereum contract.
type ZktoroStakingTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ZktoroStakingFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type ZktoroStakingFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ZktoroStakingSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type ZktoroStakingSession struct {
	Contract     *ZktoroStaking     // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// ZktoroStakingCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type ZktoroStakingCallerSession struct {
	Contract *ZktoroStakingCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts       // Call options to use throughout this session
}

// ZktoroStakingTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type ZktoroStakingTransactorSession struct {
	Contract     *ZktoroStakingTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts       // Transaction auth options to use throughout this session
}

// ZktoroStakingRaw is an auto generated low-level Go binding around an Ethereum contract.
type ZktoroStakingRaw struct {
	Contract *ZktoroStaking // Generic contract binding to access the raw methods on
}

// ZktoroStakingCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type ZktoroStakingCallerRaw struct {
	Contract *ZktoroStakingCaller // Generic read-only contract binding to access the raw methods on
}

// ZktoroStakingTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type ZktoroStakingTransactorRaw struct {
	Contract *ZktoroStakingTransactor // Generic write-only contract binding to access the raw methods on
}

// NewZktoroStaking creates a new instance of ZktoroStaking, bound to a specific deployed contract.
func NewZktoroStaking(address common.Address, backend bind.ContractBackend) (*ZktoroStaking, error) {
	contract, err := bindZktoroStaking(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &ZktoroStaking{ZktoroStakingCaller: ZktoroStakingCaller{contract: contract}, ZktoroStakingTransactor: ZktoroStakingTransactor{contract: contract}, ZktoroStakingFilterer: ZktoroStakingFilterer{contract: contract}}, nil
}

// NewZktoroStakingCaller creates a new read-only instance of ZktoroStaking, bound to a specific deployed contract.
func NewZktoroStakingCaller(address common.Address, caller bind.ContractCaller) (*ZktoroStakingCaller, error) {
	contract, err := bindZktoroStaking(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingCaller{contract: contract}, nil
}

// NewZktoroStakingTransactor creates a new write-only instance of ZktoroStaking, bound to a specific deployed contract.
func NewZktoroStakingTransactor(address common.Address, transactor bind.ContractTransactor) (*ZktoroStakingTransactor, error) {
	contract, err := bindZktoroStaking(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingTransactor{contract: contract}, nil
}

// NewZktoroStakingFilterer creates a new log filterer instance of ZktoroStaking, bound to a specific deployed contract.
func NewZktoroStakingFilterer(address common.Address, filterer bind.ContractFilterer) (*ZktoroStakingFilterer, error) {
	contract, err := bindZktoroStaking(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingFilterer{contract: contract}, nil
}

// bindZktoroStaking binds a generic wrapper to an already deployed contract.
func bindZktoroStaking(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ZktoroStakingABI))
	if err != nil {
		return nil, err
	}
...
// returns.
func (_ZktoroStaking *ZktoroStakingRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ZktoroStaking.Contract.ZktoroStakingCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ZktoroStaking *ZktoroStakingRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.ZktoroStakingTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ZktoroStaking *ZktoroStakingRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.ZktoroStakingTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_ZktoroStaking *ZktoroStakingCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _ZktoroStaking.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_ZktoroStaking *ZktoroStakingTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_ZktoroStaking *ZktoroStakingTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.contract.Transact(opts, method, params...)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) MAXSLASHABLEPERCENT(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "MAX_SLASHABLE_PERCENT")
...
//
// Solidity: function MAX_SLASHABLE_PERCENT() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) MAXSLASHABLEPERCENT() (*big.Int, error) {
	return _ZktoroStaking.Contract.MAXSLASHABLEPERCENT(&_ZktoroStaking.CallOpts)
}

// MAXSLASHABLEPERCENT is a free data retrieval call binding the contract method 0x8acdea4d.
//
// Solidity: function MAX_SLASHABLE_PERCENT() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) MAXSLASHABLEPERCENT() (*big.Int, error) {
	return _ZktoroStaking.Contract.MAXSLASHABLEPERCENT(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) MAXWITHDRAWALDELAY(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "MAX_WITHDRAWAL_DELAY")
...
//
// Solidity: function MAX_WITHDRAWAL_DELAY() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) MAXWITHDRAWALDELAY() (*big.Int, error) {
	return _ZktoroStaking.Contract.MAXWITHDRAWALDELAY(&_ZktoroStaking.CallOpts)
}

// MAXWITHDRAWALDELAY is a free data retrieval call binding the contract method 0xa238f9df.
//
// Solidity: function MAX_WITHDRAWAL_DELAY() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) MAXWITHDRAWALDELAY() (*big.Int, error) {
	return _ZktoroStaking.Contract.MAXWITHDRAWALDELAY(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) MINWITHDRAWALDELAY(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "MIN_WITHDRAWAL_DELAY")
...
//
// Solidity: function MIN_WITHDRAWAL_DELAY() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) MINWITHDRAWALDELAY() (*big.Int, error) {
	return _ZktoroStaking.Contract.MINWITHDRAWALDELAY(&_ZktoroStaking.CallOpts)
}

// MINWITHDRAWALDELAY is a free data retrieval call binding the contract method 0x4a5f2b5d.
//
// Solidity: function MIN_WITHDRAWAL_DELAY() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) MINWITHDRAWALDELAY() (*big.Int, error) {
	return _ZktoroStaking.Contract.MINWITHDRAWALDELAY(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) ActiveSharesToStake(opts *bind.CallOpts, activeSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "activeSharesToStake", activeSharesId, amount)
...
//
// Solidity: function activeSharesToStake(uint256 activeSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) ActiveSharesToStake(activeSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.ActiveSharesToStake(&_ZktoroStaking.CallOpts, activeSharesId, amount)
}

// ActiveSharesToStake is a free data retrieval call binding the contract method 0x64a0f901.
//
// Solidity: function activeSharesToStake(uint256 activeSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) ActiveSharesToStake(activeSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.ActiveSharesToStake(&_ZktoroStaking.CallOpts, activeSharesId, amount)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) ActiveStakeFor(opts *bind.CallOpts, subjectType uint8, subject *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "activeStakeFor", subjectType, subject)
...
//
// Solidity: function activeStakeFor(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) ActiveStakeFor(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.ActiveStakeFor(&_ZktoroStaking.CallOpts, subjectType, subject)
}

// ActiveStakeFor is a free data retrieval call binding the contract method 0xa290bf38.
//
// Solidity: function activeStakeFor(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) ActiveStakeFor(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.ActiveStakeFor(&_ZktoroStaking.CallOpts, subjectType, subject)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) Allocator(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "allocator")
...
//
// Solidity: function allocator() view returns(address)
func (_ZktoroStaking *ZktoroStakingSession) Allocator() (common.Address, error) {
	return _ZktoroStaking.Contract.Allocator(&_ZktoroStaking.CallOpts)
}

// Allocator is a free data retrieval call binding the contract method 0xaa5dcecc.
//
// Solidity: function allocator() view returns(address)
func (_ZktoroStaking *ZktoroStakingCallerSession) Allocator() (common.Address, error) {
	return _ZktoroStaking.Contract.Allocator(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) BalanceOf(opts *bind.CallOpts, account common.Address, id *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "balanceOf", account, id)
...
//
// Solidity: function balanceOf(address account, uint256 id) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) BalanceOf(account common.Address, id *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.BalanceOf(&_ZktoroStaking.CallOpts, account, id)
}

// BalanceOf is a free data retrieval call binding the contract method 0x00fdd58e.
//
// Solidity: function balanceOf(address account, uint256 id) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) BalanceOf(account common.Address, id *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.BalanceOf(&_ZktoroStaking.CallOpts, account, id)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) BalanceOfBatch(opts *bind.CallOpts, accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "balanceOfBatch", accounts, ids)
...
//
// Solidity: function balanceOfBatch(address[] accounts, uint256[] ids) view returns(uint256[])
func (_ZktoroStaking *ZktoroStakingSession) BalanceOfBatch(accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	return _ZktoroStaking.Contract.BalanceOfBatch(&_ZktoroStaking.CallOpts, accounts, ids)
}

// BalanceOfBatch is a free data retrieval call binding the contract method 0x4e1273f4.
//
// Solidity: function balanceOfBatch(address[] accounts, uint256[] ids) view returns(uint256[])
func (_ZktoroStaking *ZktoroStakingCallerSession) BalanceOfBatch(accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	return _ZktoroStaking.Contract.BalanceOfBatch(&_ZktoroStaking.CallOpts, accounts, ids)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) Exists(opts *bind.CallOpts, id *big.Int) (bool, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "exists", id)
...
//
// Solidity: function exists(uint256 id) view returns(bool)
func (_ZktoroStaking *ZktoroStakingSession) Exists(id *big.Int) (bool, error) {
	return _ZktoroStaking.Contract.Exists(&_ZktoroStaking.CallOpts, id)
}

// Exists is a free data retrieval call binding the contract method 0x4f558e79.
//
// Solidity: function exists(uint256 id) view returns(bool)
func (_ZktoroStaking *ZktoroStakingCallerSession) Exists(id *big.Int) (bool, error) {
	return _ZktoroStaking.Contract.Exists(&_ZktoroStaking.CallOpts, id)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) GetDelegatedSubjectType(opts *bind.CallOpts, subjectType uint8) (uint8, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "getDelegatedSubjectType", subjectType)
...
//
// Solidity: function getDelegatedSubjectType(uint8 subjectType) pure returns(uint8)
func (_ZktoroStaking *ZktoroStakingSession) GetDelegatedSubjectType(subjectType uint8) (uint8, error) {
	return _ZktoroStaking.Contract.GetDelegatedSubjectType(&_ZktoroStaking.CallOpts, subjectType)
}

// GetDelegatedSubjectType is a free data retrieval call binding the contract method 0x1daa0445.
//
// Solidity: function getDelegatedSubjectType(uint8 subjectType) pure returns(uint8)
func (_ZktoroStaking *ZktoroStakingCallerSession) GetDelegatedSubjectType(subjectType uint8) (uint8, error) {
	return _ZktoroStaking.Contract.GetDelegatedSubjectType(&_ZktoroStaking.CallOpts, subjectType)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) GetDelegatorSubjectType(opts *bind.CallOpts, subjectType uint8) (uint8, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "getDelegatorSubjectType", subjectType)
...
//
// Solidity: function getDelegatorSubjectType(uint8 subjectType) pure returns(uint8)
func (_ZktoroStaking *ZktoroStakingSession) GetDelegatorSubjectType(subjectType uint8) (uint8, error) {
	return _ZktoroStaking.Contract.GetDelegatorSubjectType(&_ZktoroStaking.CallOpts, subjectType)
}

// GetDelegatorSubjectType is a free data retrieval call binding the contract method 0xc133a562.
//
// Solidity: function getDelegatorSubjectType(uint8 subjectType) pure returns(uint8)
func (_ZktoroStaking *ZktoroStakingCallerSession) GetDelegatorSubjectType(subjectType uint8) (uint8, error) {
	return _ZktoroStaking.Contract.GetDelegatorSubjectType(&_ZktoroStaking.CallOpts, subjectType)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) GetSubjectTypeAgency(opts *bind.CallOpts, subjectType uint8) (uint8, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "getSubjectTypeAgency", subjectType)
...
//
// Solidity: function getSubjectTypeAgency(uint8 subjectType) pure returns(uint8)
func (_ZktoroStaking *ZktoroStakingSession) GetSubjectTypeAgency(subjectType uint8) (uint8, error) {
	return _ZktoroStaking.Contract.GetSubjectTypeAgency(&_ZktoroStaking.CallOpts, subjectType)
}

// GetSubjectTypeAgency is a free data retrieval call binding the contract method 0x762fa7b7.
//
// Solidity: function getSubjectTypeAgency(uint8 subjectType) pure returns(uint8)
func (_ZktoroStaking *ZktoroStakingCallerSession) GetSubjectTypeAgency(subjectType uint8) (uint8, error) {
	return _ZktoroStaking.Contract.GetSubjectTypeAgency(&_ZktoroStaking.CallOpts, subjectType)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) InactiveSharesOf(opts *bind.CallOpts, subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "inactiveSharesOf", subjectType, subject, account)
...
//
// Solidity: function inactiveSharesOf(uint8 subjectType, uint256 subject, address account) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) InactiveSharesOf(subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	return _ZktoroStaking.Contract.InactiveSharesOf(&_ZktoroStaking.CallOpts, subjectType, subject, account)
}

// InactiveSharesOf is a free data retrieval call binding the contract method 0xda5bfb94.
//
// Solidity: function inactiveSharesOf(uint8 subjectType, uint256 subject, address account) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) InactiveSharesOf(subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	return _ZktoroStaking.Contract.InactiveSharesOf(&_ZktoroStaking.CallOpts, subjectType, subject, account)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) InactiveSharesToStake(opts *bind.CallOpts, inactiveSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "inactiveSharesToStake", inactiveSharesId, amount)
...
//
// Solidity: function inactiveSharesToStake(uint256 inactiveSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) InactiveSharesToStake(inactiveSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.InactiveSharesToStake(&_ZktoroStaking.CallOpts, inactiveSharesId, amount)
}

// InactiveSharesToStake is a free data retrieval call binding the contract method 0x115a90ee.
//
// Solidity: function inactiveSharesToStake(uint256 inactiveSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) InactiveSharesToStake(inactiveSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.InactiveSharesToStake(&_ZktoroStaking.CallOpts, inactiveSharesId, amount)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) InactiveStakeFor(opts *bind.CallOpts, subjectType uint8, subject *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "inactiveStakeFor", subjectType, subject)
...
//
// Solidity: function inactiveStakeFor(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) InactiveStakeFor(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.InactiveStakeFor(&_ZktoroStaking.CallOpts, subjectType, subject)
}

// InactiveStakeFor is a free data retrieval call binding the contract method 0xdc4653ef.
//
// Solidity: function inactiveStakeFor(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) InactiveStakeFor(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.InactiveStakeFor(&_ZktoroStaking.CallOpts, subjectType, subject)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) IsApprovedForAll(opts *bind.CallOpts, account common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "isApprovedForAll", account, operator)
...
//
// Solidity: function isApprovedForAll(address account, address operator) view returns(bool)
func (_ZktoroStaking *ZktoroStakingSession) IsApprovedForAll(account common.Address, operator common.Address) (bool, error) {
	return _ZktoroStaking.Contract.IsApprovedForAll(&_ZktoroStaking.CallOpts, account, operator)
}

// IsApprovedForAll is a free data retrieval call binding the contract method 0xe985e9c5.
//
// Solidity: function isApprovedForAll(address account, address operator) view returns(bool)
func (_ZktoroStaking *ZktoroStakingCallerSession) IsApprovedForAll(account common.Address, operator common.Address) (bool, error) {
	return _ZktoroStaking.Contract.IsApprovedForAll(&_ZktoroStaking.CallOpts, account, operator)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) IsFrozen(opts *bind.CallOpts, subjectType uint8, subject *big.Int) (bool, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "isFrozen", subjectType, subject)
...
//
// Solidity: function isFrozen(uint8 subjectType, uint256 subject) view returns(bool)
func (_ZktoroStaking *ZktoroStakingSession) IsFrozen(subjectType uint8, subject *big.Int) (bool, error) {
	return _ZktoroStaking.Contract.IsFrozen(&_ZktoroStaking.CallOpts, subjectType, subject)
}

// IsFrozen is a free data retrieval call binding the contract method 0x75e130ad.
//
// Solidity: function isFrozen(uint8 subjectType, uint256 subject) view returns(bool)
func (_ZktoroStaking *ZktoroStakingCallerSession) IsFrozen(subjectType uint8, subject *big.Int) (bool, error) {
	return _ZktoroStaking.Contract.IsFrozen(&_ZktoroStaking.CallOpts, subjectType, subject)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) IsTrustedForwarder(opts *bind.CallOpts, forwarder common.Address) (bool, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "isTrustedForwarder", forwarder)
...
//
// Solidity: function isTrustedForwarder(address forwarder) view returns(bool)
func (_ZktoroStaking *ZktoroStakingSession) IsTrustedForwarder(forwarder common.Address) (bool, error) {
	return _ZktoroStaking.Contract.IsTrustedForwarder(&_ZktoroStaking.CallOpts, forwarder)
}

// IsTrustedForwarder is a free data retrieval call binding the contract method 0x572b6c05.
//
// Solidity: function isTrustedForwarder(address forwarder) view returns(bool)
func (_ZktoroStaking *ZktoroStakingCallerSession) IsTrustedForwarder(forwarder common.Address) (bool, error) {
	return _ZktoroStaking.Contract.IsTrustedForwarder(&_ZktoroStaking.CallOpts, forwarder)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) OpenProposals(opts *bind.CallOpts, arg0 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "openProposals", arg0)
...
//
// Solidity: function openProposals(uint256 ) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) OpenProposals(arg0 *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.OpenProposals(&_ZktoroStaking.CallOpts, arg0)
}

// OpenProposals is a free data retrieval call binding the contract method 0x46e89787.
//
// Solidity: function openProposals(uint256 ) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) OpenProposals(arg0 *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.OpenProposals(&_ZktoroStaking.CallOpts, arg0)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) ProxiableUUID(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "proxiableUUID")
...
//
// Solidity: function proxiableUUID() view returns(bytes32)
func (_ZktoroStaking *ZktoroStakingSession) ProxiableUUID() ([32]byte, error) {
	return _ZktoroStaking.Contract.ProxiableUUID(&_ZktoroStaking.CallOpts)
}

// ProxiableUUID is a free data retrieval call binding the contract method 0x52d1902d.
//
// Solidity: function proxiableUUID() view returns(bytes32)
func (_ZktoroStaking *ZktoroStakingCallerSession) ProxiableUUID() ([32]byte, error) {
	return _ZktoroStaking.Contract.ProxiableUUID(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) SharesOf(opts *bind.CallOpts, subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "sharesOf", subjectType, subject, account)
...
//
// Solidity: function sharesOf(uint8 subjectType, uint256 subject, address account) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) SharesOf(subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	return _ZktoroStaking.Contract.SharesOf(&_ZktoroStaking.CallOpts, subjectType, subject, account)
}

// SharesOf is a free data retrieval call binding the contract method 0xf08d35ee.
//
// Solidity: function sharesOf(uint8 subjectType, uint256 subject, address account) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) SharesOf(subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	return _ZktoroStaking.Contract.SharesOf(&_ZktoroStaking.CallOpts, subjectType, subject, account)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) SlashDelegatorsPercent(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "slashDelegatorsPercent")
...
//
// Solidity: function slashDelegatorsPercent() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) SlashDelegatorsPercent() (*big.Int, error) {
	return _ZktoroStaking.Contract.SlashDelegatorsPercent(&_ZktoroStaking.CallOpts)
}

// SlashDelegatorsPercent is a free data retrieval call binding the contract method 0x90f1ccba.
//
// Solidity: function slashDelegatorsPercent() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) SlashDelegatorsPercent() (*big.Int, error) {
	return _ZktoroStaking.Contract.SlashDelegatorsPercent(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) StakeToActiveShares(opts *bind.CallOpts, activeSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "stakeToActiveShares", activeSharesId, amount)
...
//
// Solidity: function stakeToActiveShares(uint256 activeSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) StakeToActiveShares(activeSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.StakeToActiveShares(&_ZktoroStaking.CallOpts, activeSharesId, amount)
}

// StakeToActiveShares is a free data retrieval call binding the contract method 0x1a82ef4e.
//
// Solidity: function stakeToActiveShares(uint256 activeSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) StakeToActiveShares(activeSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.StakeToActiveShares(&_ZktoroStaking.CallOpts, activeSharesId, amount)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) StakeToInactiveShares(opts *bind.CallOpts, inactiveSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "stakeToInactiveShares", inactiveSharesId, amount)
...
//
// Solidity: function stakeToInactiveShares(uint256 inactiveSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) StakeToInactiveShares(inactiveSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.StakeToInactiveShares(&_ZktoroStaking.CallOpts, inactiveSharesId, amount)
}

// StakeToInactiveShares is a free data retrieval call binding the contract method 0x62772b14.
//
// Solidity: function stakeToInactiveShares(uint256 inactiveSharesId, uint256 amount) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) StakeToInactiveShares(inactiveSharesId *big.Int, amount *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.StakeToInactiveShares(&_ZktoroStaking.CallOpts, inactiveSharesId, amount)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) StakedToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "stakedToken")
...
//
// Solidity: function stakedToken() view returns(address)
func (_ZktoroStaking *ZktoroStakingSession) StakedToken() (common.Address, error) {
	return _ZktoroStaking.Contract.StakedToken(&_ZktoroStaking.CallOpts)
}

// StakedToken is a free data retrieval call binding the contract method 0xcc7a262e.
//
// Solidity: function stakedToken() view returns(address)
func (_ZktoroStaking *ZktoroStakingCallerSession) StakedToken() (common.Address, error) {
	return _ZktoroStaking.Contract.StakedToken(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) SubjectGateway(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "subjectGateway")
...
//
// Solidity: function subjectGateway() view returns(address)
func (_ZktoroStaking *ZktoroStakingSession) SubjectGateway() (common.Address, error) {
	return _ZktoroStaking.Contract.SubjectGateway(&_ZktoroStaking.CallOpts)
}

// SubjectGateway is a free data retrieval call binding the contract method 0x1fd5a956.
//
// Solidity: function subjectGateway() view returns(address)
func (_ZktoroStaking *ZktoroStakingCallerSession) SubjectGateway() (common.Address, error) {
	return _ZktoroStaking.Contract.SubjectGateway(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_ZktoroStaking *ZktoroStakingSession) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _ZktoroStaking.Contract.SupportsInterface(&_ZktoroStaking.CallOpts, interfaceId)
}

// SupportsInterface is a free data retrieval call binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_ZktoroStaking *ZktoroStakingCallerSession) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _ZktoroStaking.Contract.SupportsInterface(&_ZktoroStaking.CallOpts, interfaceId)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) TotalActiveStake(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "totalActiveStake")
...
//
// Solidity: function totalActiveStake() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) TotalActiveStake() (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalActiveStake(&_ZktoroStaking.CallOpts)
}

// TotalActiveStake is a free data retrieval call binding the contract method 0x28f73148.
//
// Solidity: function totalActiveStake() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) TotalActiveStake() (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalActiveStake(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) TotalInactiveShares(opts *bind.CallOpts, subjectType uint8, subject *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "totalInactiveShares", subjectType, subject)
...
//
// Solidity: function totalInactiveShares(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) TotalInactiveShares(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalInactiveShares(&_ZktoroStaking.CallOpts, subjectType, subject)
}

// TotalInactiveShares is a free data retrieval call binding the contract method 0x321ebc54.
//
// Solidity: function totalInactiveShares(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) TotalInactiveShares(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalInactiveShares(&_ZktoroStaking.CallOpts, subjectType, subject)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) TotalInactiveStake(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "totalInactiveStake")
...
//
// Solidity: function totalInactiveStake() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) TotalInactiveStake() (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalInactiveStake(&_ZktoroStaking.CallOpts)
}

// TotalInactiveStake is a free data retrieval call binding the contract method 0x371f4226.
//
// Solidity: function totalInactiveStake() view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) TotalInactiveStake() (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalInactiveStake(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) TotalShares(opts *bind.CallOpts, subjectType uint8, subject *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "totalShares", subjectType, subject)
...
//
// Solidity: function totalShares(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) TotalShares(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalShares(&_ZktoroStaking.CallOpts, subjectType, subject)
}

// TotalShares is a free data retrieval call binding the contract method 0x0e10103f.
//
// Solidity: function totalShares(uint8 subjectType, uint256 subject) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) TotalShares(subjectType uint8, subject *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalShares(&_ZktoroStaking.CallOpts, subjectType, subject)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) TotalSupply(opts *bind.CallOpts, id *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "totalSupply", id)
...
//
// Solidity: function totalSupply(uint256 id) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) TotalSupply(id *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalSupply(&_ZktoroStaking.CallOpts, id)
}

// TotalSupply is a free data retrieval call binding the contract method 0xbd85b039.
//
// Solidity: function totalSupply(uint256 id) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) TotalSupply(id *big.Int) (*big.Int, error) {
	return _ZktoroStaking.Contract.TotalSupply(&_ZktoroStaking.CallOpts, id)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) Treasury(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "treasury")
...
//
// Solidity: function treasury() view returns(address)
func (_ZktoroStaking *ZktoroStakingSession) Treasury() (common.Address, error) {
	return _ZktoroStaking.Contract.Treasury(&_ZktoroStaking.CallOpts)
}

// Treasury is a free data retrieval call binding the contract method 0x61d027b3.
//
// Solidity: function treasury() view returns(address)
func (_ZktoroStaking *ZktoroStakingCallerSession) Treasury() (common.Address, error) {
	return _ZktoroStaking.Contract.Treasury(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) Uri(opts *bind.CallOpts, arg0 *big.Int) (string, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "uri", arg0)
...
//
// Solidity: function uri(uint256 ) view returns(string)
func (_ZktoroStaking *ZktoroStakingSession) Uri(arg0 *big.Int) (string, error) {
	return _ZktoroStaking.Contract.Uri(&_ZktoroStaking.CallOpts, arg0)
}

// Uri is a free data retrieval call binding the contract method 0x0e89341c.
//
// Solidity: function uri(uint256 ) view returns(string)
func (_ZktoroStaking *ZktoroStakingCallerSession) Uri(arg0 *big.Int) (string, error) {
	return _ZktoroStaking.Contract.Uri(&_ZktoroStaking.CallOpts, arg0)
}
...
func (_ZktoroStaking *ZktoroStakingCaller) Version(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "version")
...
//
// Solidity: function version() view returns(string)
func (_ZktoroStaking *ZktoroStakingSession) Version() (string, error) {
	return _ZktoroStaking.Contract.Version(&_ZktoroStaking.CallOpts)
}

// Version is a free data retrieval call binding the contract method 0x54fd4d50.
//
// Solidity: function version() view returns(string)
func (_ZktoroStaking *ZktoroStakingCallerSession) Version() (string, error) {
	return _ZktoroStaking.Contract.Version(&_ZktoroStaking.CallOpts)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) ConfigureStakeHelpers(opts *bind.TransactOpts, _subjectGateway common.Address, _allocator common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "configureStakeHelpers", _subjectGateway, _allocator)
}

// ConfigureStakeHelpers is a paid mutator transaction binding the contract method 0x3c3e04dd.
//
// Solidity: function configureStakeHelpers(address _subjectGateway, address _allocator) returns()
func (_ZktoroStaking *ZktoroStakingSession) ConfigureStakeHelpers(_subjectGateway common.Address, _allocator common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.ConfigureStakeHelpers(&_ZktoroStaking.TransactOpts, _subjectGateway, _allocator)
}

// ConfigureStakeHelpers is a paid mutator transaction binding the contract method 0x3c3e04dd.
//
// Solidity: function configureStakeHelpers(address _subjectGateway, address _allocator) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) ConfigureStakeHelpers(_subjectGateway common.Address, _allocator common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.ConfigureStakeHelpers(&_ZktoroStaking.TransactOpts, _subjectGateway, _allocator)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Deposit(opts *bind.TransactOpts, subjectType uint8, subject *big.Int, stakeValue *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "deposit", subjectType, subject, stakeValue)
}

// Deposit is a paid mutator transaction binding the contract method 0x2cb31144.
//
// Solidity: function deposit(uint8 subjectType, uint256 subject, uint256 stakeValue) returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) Deposit(subjectType uint8, subject *big.Int, stakeValue *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Deposit(&_ZktoroStaking.TransactOpts, subjectType, subject, stakeValue)
}

// Deposit is a paid mutator transaction binding the contract method 0x2cb31144.
//
// Solidity: function deposit(uint8 subjectType, uint256 subject, uint256 stakeValue) returns(uint256)
func (_ZktoroStaking *ZktoroStakingTransactorSession) Deposit(subjectType uint8, subject *big.Int, stakeValue *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Deposit(&_ZktoroStaking.TransactOpts, subjectType, subject, stakeValue)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) DisableRouter(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "disableRouter")
}

// DisableRouter is a paid mutator transaction binding the contract method 0xd858a7e5.
//
// Solidity: function disableRouter() returns()
func (_ZktoroStaking *ZktoroStakingSession) DisableRouter() (*types.Transaction, error) {
	return _ZktoroStaking.Contract.DisableRouter(&_ZktoroStaking.TransactOpts)
}

// DisableRouter is a paid mutator transaction binding the contract method 0xd858a7e5.
//
// Solidity: function disableRouter() returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) DisableRouter() (*types.Transaction, error) {
	return _ZktoroStaking.Contract.DisableRouter(&_ZktoroStaking.TransactOpts)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Freeze(opts *bind.TransactOpts, subjectType uint8, subject *big.Int, frozen bool) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "freeze", subjectType, subject, frozen)
}

// Freeze is a paid mutator transaction binding the contract method 0x226cc300.
//
// Solidity: function freeze(uint8 subjectType, uint256 subject, bool frozen) returns()
func (_ZktoroStaking *ZktoroStakingSession) Freeze(subjectType uint8, subject *big.Int, frozen bool) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Freeze(&_ZktoroStaking.TransactOpts, subjectType, subject, frozen)
}

// Freeze is a paid mutator transaction binding the contract method 0x226cc300.
//
// Solidity: function freeze(uint8 subjectType, uint256 subject, bool frozen) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) Freeze(subjectType uint8, subject *big.Int, frozen bool) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Freeze(&_ZktoroStaking.TransactOpts, subjectType, subject, frozen)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Initialize(opts *bind.TransactOpts, __manager common.Address, __stakedToken common.Address, __withdrawalDelay uint64, __treasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "initialize", __manager, __stakedToken, __withdrawalDelay, __treasury)
}

// Initialize is a paid mutator transaction binding the contract method 0x4e04275f.
//
// Solidity: function initialize(address __manager, address __stakedToken, uint64 __withdrawalDelay, address __treasury) returns()
func (_ZktoroStaking *ZktoroStakingSession) Initialize(__manager common.Address, __stakedToken common.Address, __withdrawalDelay uint64, __treasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Initialize(&_ZktoroStaking.TransactOpts, __manager, __stakedToken, __withdrawalDelay, __treasury)
}

// Initialize is a paid mutator transaction binding the contract method 0x4e04275f.
//
// Solidity: function initialize(address __manager, address __stakedToken, uint64 __withdrawalDelay, address __treasury) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) Initialize(__manager common.Address, __stakedToken common.Address, __withdrawalDelay uint64, __treasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Initialize(&_ZktoroStaking.TransactOpts, __manager, __stakedToken, __withdrawalDelay, __treasury)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) InitiateWithdrawal(opts *bind.TransactOpts, subjectType uint8, subject *big.Int, sharesValue *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "initiateWithdrawal", subjectType, subject, sharesValue)
}

// InitiateWithdrawal is a paid mutator transaction binding the contract method 0xedea0bac.
//
// Solidity: function initiateWithdrawal(uint8 subjectType, uint256 subject, uint256 sharesValue) returns(uint64)
func (_ZktoroStaking *ZktoroStakingSession) InitiateWithdrawal(subjectType uint8, subject *big.Int, sharesValue *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.InitiateWithdrawal(&_ZktoroStaking.TransactOpts, subjectType, subject, sharesValue)
}

// InitiateWithdrawal is a paid mutator transaction binding the contract method 0xedea0bac.
//
// Solidity: function initiateWithdrawal(uint8 subjectType, uint256 subject, uint256 sharesValue) returns(uint64)
func (_ZktoroStaking *ZktoroStakingTransactorSession) InitiateWithdrawal(subjectType uint8, subject *big.Int, sharesValue *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.InitiateWithdrawal(&_ZktoroStaking.TransactOpts, subjectType, subject, sharesValue)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Migrate(opts *bind.TransactOpts, oldSubjectType uint8, oldSubject *big.Int, newSubjectType uint8, newSubject *big.Int, staker common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "migrate", oldSubjectType, oldSubject, newSubjectType, newSubject, staker)
}

// Migrate is a paid mutator transaction binding the contract method 0x093af6a9.
//
// Solidity: function migrate(uint8 oldSubjectType, uint256 oldSubject, uint8 newSubjectType, uint256 newSubject, address staker) returns()
func (_ZktoroStaking *ZktoroStakingSession) Migrate(oldSubjectType uint8, oldSubject *big.Int, newSubjectType uint8, newSubject *big.Int, staker common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Migrate(&_ZktoroStaking.TransactOpts, oldSubjectType, oldSubject, newSubjectType, newSubject, staker)
}

// Migrate is a paid mutator transaction binding the contract method 0x093af6a9.
//
// Solidity: function migrate(uint8 oldSubjectType, uint256 oldSubject, uint8 newSubjectType, uint256 newSubject, address staker) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) Migrate(oldSubjectType uint8, oldSubject *big.Int, newSubjectType uint8, newSubject *big.Int, staker common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Migrate(&_ZktoroStaking.TransactOpts, oldSubjectType, oldSubject, newSubjectType, newSubject, staker)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Multicall(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "multicall", data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) returns(bytes[] results)
func (_ZktoroStaking *ZktoroStakingSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Multicall(&_ZktoroStaking.TransactOpts, data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) returns(bytes[] results)
func (_ZktoroStaking *ZktoroStakingTransactorSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Multicall(&_ZktoroStaking.TransactOpts, data)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) RelayPermit(opts *bind.TransactOpts, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "relayPermit", value, deadline, v, r, s)
}

// RelayPermit is a paid mutator transaction binding the contract method 0xc07975ad.
//
// Solidity: function relayPermit(uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) returns()
func (_ZktoroStaking *ZktoroStakingSession) RelayPermit(value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.RelayPermit(&_ZktoroStaking.TransactOpts, value, deadline, v, r, s)
}

// RelayPermit is a paid mutator transaction binding the contract method 0xc07975ad.
//
// Solidity: function relayPermit(uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) RelayPermit(value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.RelayPermit(&_ZktoroStaking.TransactOpts, value, deadline, v, r, s)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SafeBatchTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "safeBatchTransferFrom", from, to, ids, amounts, data)
}

// SafeBatchTransferFrom is a paid mutator transaction binding the contract method 0x2eb2c2d6.
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] amounts, bytes data) returns()
func (_ZktoroStaking *ZktoroStakingSession) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SafeBatchTransferFrom(&_ZktoroStaking.TransactOpts, from, to, ids, amounts, data)
}

// SafeBatchTransferFrom is a paid mutator transaction binding the contract method 0x2eb2c2d6.
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] amounts, bytes data) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SafeBatchTransferFrom(&_ZktoroStaking.TransactOpts, from, to, ids, amounts, data)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "safeTransferFrom", from, to, id, amount, data)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0xf242432a.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes data) returns()
func (_ZktoroStaking *ZktoroStakingSession) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SafeTransferFrom(&_ZktoroStaking.TransactOpts, from, to, id, amount, data)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0xf242432a.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes data) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SafeTransferFrom(&_ZktoroStaking.TransactOpts, from, to, id, amount, data)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetAccessManager(opts *bind.TransactOpts, newManager common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setAccessManager", newManager)
}

// SetAccessManager is a paid mutator transaction binding the contract method 0xc9580804.
//
// Solidity: function setAccessManager(address newManager) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetAccessManager(newManager common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetAccessManager(&_ZktoroStaking.TransactOpts, newManager)
}

// SetAccessManager is a paid mutator transaction binding the contract method 0xc9580804.
//
// Solidity: function setAccessManager(address newManager) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetAccessManager(newManager common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetAccessManager(&_ZktoroStaking.TransactOpts, newManager)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetApprovalForAll(&_ZktoroStaking.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetApprovalForAll(&_ZktoroStaking.TransactOpts, operator, approved)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetDelay(opts *bind.TransactOpts, newDelay uint64) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setDelay", newDelay)
}

// SetDelay is a paid mutator transaction binding the contract method 0xc1073302.
//
// Solidity: function setDelay(uint64 newDelay) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetDelay(newDelay uint64) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetDelay(&_ZktoroStaking.TransactOpts, newDelay)
}

// SetDelay is a paid mutator transaction binding the contract method 0xc1073302.
//
// Solidity: function setDelay(uint64 newDelay) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetDelay(newDelay uint64) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetDelay(&_ZktoroStaking.TransactOpts, newDelay)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetName(opts *bind.TransactOpts, ensRegistry common.Address, ensName string) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setName", ensRegistry, ensName)
}

// SetName is a paid mutator transaction binding the contract method 0x3121db1c.
//
// Solidity: function setName(address ensRegistry, string ensName) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetName(ensRegistry common.Address, ensName string) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetName(&_ZktoroStaking.TransactOpts, ensRegistry, ensName)
}

// SetName is a paid mutator transaction binding the contract method 0x3121db1c.
//
// Solidity: function setName(address ensRegistry, string ensName) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetName(ensRegistry common.Address, ensName string) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetName(&_ZktoroStaking.TransactOpts, ensRegistry, ensName)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetReentrancyGuard(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setReentrancyGuard")
}

// SetReentrancyGuard is a paid mutator transaction binding the contract method 0xedac6db8.
//
// Solidity: function setReentrancyGuard() returns()
func (_ZktoroStaking *ZktoroStakingSession) SetReentrancyGuard() (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetReentrancyGuard(&_ZktoroStaking.TransactOpts)
}

// SetReentrancyGuard is a paid mutator transaction binding the contract method 0xedac6db8.
//
// Solidity: function setReentrancyGuard() returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetReentrancyGuard() (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetReentrancyGuard(&_ZktoroStaking.TransactOpts)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetSlashDelegatorsPercent(opts *bind.TransactOpts, percent *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setSlashDelegatorsPercent", percent)
}

// SetSlashDelegatorsPercent is a paid mutator transaction binding the contract method 0xb4d60fb3.
//
// Solidity: function setSlashDelegatorsPercent(uint256 percent) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetSlashDelegatorsPercent(percent *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetSlashDelegatorsPercent(&_ZktoroStaking.TransactOpts, percent)
}

// SetSlashDelegatorsPercent is a paid mutator transaction binding the contract method 0xb4d60fb3.
//
// Solidity: function setSlashDelegatorsPercent(uint256 percent) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetSlashDelegatorsPercent(percent *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetSlashDelegatorsPercent(&_ZktoroStaking.TransactOpts, percent)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetTreasury(opts *bind.TransactOpts, newTreasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setTreasury", newTreasury)
}

// SetTreasury is a paid mutator transaction binding the contract method 0xf0f44260.
//
// Solidity: function setTreasury(address newTreasury) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetTreasury(newTreasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetTreasury(&_ZktoroStaking.TransactOpts, newTreasury)
}

// SetTreasury is a paid mutator transaction binding the contract method 0xf0f44260.
//
// Solidity: function setTreasury(address newTreasury) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetTreasury(newTreasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetTreasury(&_ZktoroStaking.TransactOpts, newTreasury)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetURI(opts *bind.TransactOpts, newUri string) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setURI", newUri)
}

// SetURI is a paid mutator transaction binding the contract method 0x02fe5305.
//
// Solidity: function setURI(string newUri) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetURI(newUri string) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetURI(&_ZktoroStaking.TransactOpts, newUri)
}

// SetURI is a paid mutator transaction binding the contract method 0x02fe5305.
//
// Solidity: function setURI(string newUri) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetURI(newUri string) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetURI(&_ZktoroStaking.TransactOpts, newUri)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Slash(opts *bind.TransactOpts, subjectType uint8, subject *big.Int, stakeValue *big.Int, proposer common.Address, proposerPercent *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "slash", subjectType, subject, stakeValue, proposer, proposerPercent)
}

// Slash is a paid mutator transaction binding the contract method 0xf8058b06.
//
// Solidity: function slash(uint8 subjectType, uint256 subject, uint256 stakeValue, address proposer, uint256 proposerPercent) returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) Slash(subjectType uint8, subject *big.Int, stakeValue *big.Int, proposer common.Address, proposerPercent *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Slash(&_ZktoroStaking.TransactOpts, subjectType, subject, stakeValue, proposer, proposerPercent)
}

// Slash is a paid mutator transaction binding the contract method 0xf8058b06.
//
// Solidity: function slash(uint8 subjectType, uint256 subject, uint256 stakeValue, address proposer, uint256 proposerPercent) returns(uint256)
func (_ZktoroStaking *ZktoroStakingTransactorSession) Slash(subjectType uint8, subject *big.Int, stakeValue *big.Int, proposer common.Address, proposerPercent *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Slash(&_ZktoroStaking.TransactOpts, subjectType, subject, stakeValue, proposer, proposerPercent)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Sweep(opts *bind.TransactOpts, token common.Address, recipient common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "sweep", token, recipient)
}

// Sweep is a paid mutator transaction binding the contract method 0xb8dc491b.
//
// Solidity: function sweep(address token, address recipient) returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) Sweep(token common.Address, recipient common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Sweep(&_ZktoroStaking.TransactOpts, token, recipient)
}

// Sweep is a paid mutator transaction binding the contract method 0xb8dc491b.
//
// Solidity: function sweep(address token, address recipient) returns(uint256)
func (_ZktoroStaking *ZktoroStakingTransactorSession) Sweep(token common.Address, recipient common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Sweep(&_ZktoroStaking.TransactOpts, token, recipient)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) UpgradeTo(opts *bind.TransactOpts, newImplementation common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "upgradeTo", newImplementation)
}

// UpgradeTo is a paid mutator transaction binding the contract method 0x3659cfe6.
//
// Solidity: function upgradeTo(address newImplementation) returns()
func (_ZktoroStaking *ZktoroStakingSession) UpgradeTo(newImplementation common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.UpgradeTo(&_ZktoroStaking.TransactOpts, newImplementation)
}

// UpgradeTo is a paid mutator transaction binding the contract method 0x3659cfe6.
//
// Solidity: function upgradeTo(address newImplementation) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) UpgradeTo(newImplementation common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.UpgradeTo(&_ZktoroStaking.TransactOpts, newImplementation)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) UpgradeToAndCall(opts *bind.TransactOpts, newImplementation common.Address, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "upgradeToAndCall", newImplementation, data)
}

// UpgradeToAndCall is a paid mutator transaction binding the contract method 0x4f1ef286.
//
// Solidity: function upgradeToAndCall(address newImplementation, bytes data) payable returns()
func (_ZktoroStaking *ZktoroStakingSession) UpgradeToAndCall(newImplementation common.Address, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.UpgradeToAndCall(&_ZktoroStaking.TransactOpts, newImplementation, data)
}

// UpgradeToAndCall is a paid mutator transaction binding the contract method 0x4f1ef286.
//
// Solidity: function upgradeToAndCall(address newImplementation, bytes data) payable returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) UpgradeToAndCall(newImplementation common.Address, data []byte) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.UpgradeToAndCall(&_ZktoroStaking.TransactOpts, newImplementation, data)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Withdraw(opts *bind.TransactOpts, subjectType uint8, subject *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "withdraw", subjectType, subject)
}

// Withdraw is a paid mutator transaction binding the contract method 0x3f489914.
//
// Solidity: function withdraw(uint8 subjectType, uint256 subject) returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) Withdraw(subjectType uint8, subject *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Withdraw(&_ZktoroStaking.TransactOpts, subjectType, subject)
}

// Withdraw is a paid mutator transaction binding the contract method 0x3f489914.
//
// Solidity: function withdraw(uint8 subjectType, uint256 subject) returns(uint256)
func (_ZktoroStaking *ZktoroStakingTransactorSession) Withdraw(subjectType uint8, subject *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Withdraw(&_ZktoroStaking.TransactOpts, subjectType, subject)
}

// ZktoroStakingAccessManagerUpdatedIterator is returned from FilterAccessManagerUpdated and is used to iterate over the raw logs and unpacked data for AccessManagerUpdated events raised by the ZktoroStaking contract.
type ZktoroStakingAccessManagerUpdatedIterator struct {
	Event *ZktoroStakingAccessManagerUpdated // Event containing the contract specifics and raw log
...
func (it *ZktoroStakingAccessManagerUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingAccessManagerUpdated)
...
func (it *ZktoroStakingAccessManagerUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingAccessManagerUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingAccessManagerUpdated represents a AccessManagerUpdated event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterAccessManagerUpdated(opts *bind.FilterOpts, newAddressManager []common.Address) (*ZktoroStakingAccessManagerUpdatedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "AccessManagerUpdated", newAddressManagerRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingAccessManagerUpdatedIterator{contract: _ZktoroStaking.contract, event: "AccessManagerUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event AccessManagerUpdated(address indexed newAddressManager)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchAccessManagerUpdated(opts *bind.WatchOpts, sink chan<- *ZktoroStakingAccessManagerUpdated, newAddressManager []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "AccessManagerUpdated", newAddressManagerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(ZktoroStakingAccessManagerUpdated)
				if err := _ZktoroStaking.contract.UnpackLog(event, "AccessManagerUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AccessManagerUpdated(address indexed newAddressManager)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseAccessManagerUpdated(log types.Log) (*ZktoroStakingAccessManagerUpdated, error) {
	event := new(ZktoroStakingAccessManagerUpdated)
	if err := _ZktoroStaking.contract.UnpackLog(event, "AccessManagerUpdated", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingAdminChangedIterator is returned from FilterAdminChanged and is used to iterate over the raw logs and unpacked data for AdminChanged events raised by the ZktoroStaking contract.
type ZktoroStakingAdminChangedIterator struct {
	Event *ZktoroStakingAdminChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingAdminChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingAdminChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingAdminChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingAdminChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingAdminChanged represents a AdminChanged event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterAdminChanged(opts *bind.FilterOpts) (*ZktoroStakingAdminChangedIterator, error) {

	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "AdminChanged")
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingAdminChangedIterator{contract: _ZktoroStaking.contract, event: "AdminChanged", logs: logs, sub: sub}, nil
}

// WatchAdminChanged is a free log subscription operation binding the contract event 0x7e644d79422f17c01e4894b5f4f588d331ebfa28653d42ae832dc59e38c9798f.
//
// Solidity: event AdminChanged(address previousAdmin, address newAdmin)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchAdminChanged(opts *bind.WatchOpts, sink chan<- *ZktoroStakingAdminChanged) (event.Subscription, error) {

	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "AdminChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingAdminChanged)
				if err := _ZktoroStaking.contract.UnpackLog(event, "AdminChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event AdminChanged(address previousAdmin, address newAdmin)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseAdminChanged(log types.Log) (*ZktoroStakingAdminChanged, error) {
	event := new(ZktoroStakingAdminChanged)
	if err := _ZktoroStaking.contract.UnpackLog(event, "AdminChanged", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingApprovalForAllIterator is returned from FilterApprovalForAll and is used to iterate over the raw logs and unpacked data for ApprovalForAll events raised by the ZktoroStaking contract.
type ZktoroStakingApprovalForAllIterator struct {
	Event *ZktoroStakingApprovalForAll // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingApprovalForAllIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingApprovalForAll)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingApprovalForAllIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingApprovalForAllIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingApprovalForAll represents a ApprovalForAll event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterApprovalForAll(opts *bind.FilterOpts, account []common.Address, operator []common.Address) (*ZktoroStakingApprovalForAllIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingApprovalForAllIterator{contract: _ZktoroStaking.contract, event: "ApprovalForAll", logs: logs, sub: sub}, nil
}

// WatchApprovalForAll is a free log subscription operation binding the contract event 0x17307eab39ab6107e8899845ad3d59bd9653f200f220920489ca2b5937696c31.
//
// Solidity: event ApprovalForAll(address indexed account, address indexed operator, bool approved)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchApprovalForAll(opts *bind.WatchOpts, sink chan<- *ZktoroStakingApprovalForAll, account []common.Address, operator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingApprovalForAll)
				if err := _ZktoroStaking.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ApprovalForAll(address indexed account, address indexed operator, bool approved)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseApprovalForAll(log types.Log) (*ZktoroStakingApprovalForAll, error) {
	event := new(ZktoroStakingApprovalForAll)
	if err := _ZktoroStaking.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingBeaconUpgradedIterator is returned from FilterBeaconUpgraded and is used to iterate over the raw logs and unpacked data for BeaconUpgraded events raised by the ZktoroStaking contract.
type ZktoroStakingBeaconUpgradedIterator struct {
	Event *ZktoroStakingBeaconUpgraded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingBeaconUpgradedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingBeaconUpgraded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingBeaconUpgradedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingBeaconUpgradedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingBeaconUpgraded represents a BeaconUpgraded event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterBeaconUpgraded(opts *bind.FilterOpts, beacon []common.Address) (*ZktoroStakingBeaconUpgradedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "BeaconUpgraded", beaconRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingBeaconUpgradedIterator{contract: _ZktoroStaking.contract, event: "BeaconUpgraded", logs: logs, sub: sub}, nil
}

// WatchBeaconUpgraded is a free log subscription operation binding the contract event 0x1cf3b03a6cf19fa2baba4df148e9dcabedea7f8a5c07840e207e5c089be95d3e.
//
// Solidity: event BeaconUpgraded(address indexed beacon)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchBeaconUpgraded(opts *bind.WatchOpts, sink chan<- *ZktoroStakingBeaconUpgraded, beacon []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "BeaconUpgraded", beaconRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingBeaconUpgraded)
				if err := _ZktoroStaking.contract.UnpackLog(event, "BeaconUpgraded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event BeaconUpgraded(address indexed beacon)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseBeaconUpgraded(log types.Log) (*ZktoroStakingBeaconUpgraded, error) {
	event := new(ZktoroStakingBeaconUpgraded)
	if err := _ZktoroStaking.contract.UnpackLog(event, "BeaconUpgraded", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingDelaySetIterator is returned from FilterDelaySet and is used to iterate over the raw logs and unpacked data for DelaySet events raised by the ZktoroStaking contract.
type ZktoroStakingDelaySetIterator struct {
	Event *ZktoroStakingDelaySet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingDelaySetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingDelaySet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingDelaySetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingDelaySetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingDelaySet represents a DelaySet event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterDelaySet(opts *bind.FilterOpts) (*ZktoroStakingDelaySetIterator, error) {

	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "DelaySet")
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingDelaySetIterator{contract: _ZktoroStaking.contract, event: "DelaySet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DelaySet(uint256 newWithdrawalDelay)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchDelaySet(opts *bind.WatchOpts, sink chan<- *ZktoroStakingDelaySet) (event.Subscription, error) {

	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "DelaySet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingDelaySet)
				if err := _ZktoroStaking.contract.UnpackLog(event, "DelaySet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DelaySet(uint256 newWithdrawalDelay)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseDelaySet(log types.Log) (*ZktoroStakingDelaySet, error) {
	event := new(ZktoroStakingDelaySet)
	if err := _ZktoroStaking.contract.UnpackLog(event, "DelaySet", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingFrozeIterator is returned from FilterFroze and is used to iterate over the raw logs and unpacked data for Froze events raised by the ZktoroStaking contract.
type ZktoroStakingFrozeIterator struct {
	Event *ZktoroStakingFroze // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingFrozeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingFroze)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingFrozeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingFrozeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingFroze represents a Froze event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterFroze(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, by []common.Address) (*ZktoroStakingFrozeIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "Froze", subjectTypeRule, subjectRule, byRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingFrozeIterator{contract: _ZktoroStaking.contract, event: "Froze", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Froze(uint8 indexed subjectType, uint256 indexed subject, address indexed by, bool isFrozen)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchFroze(opts *bind.WatchOpts, sink chan<- *ZktoroStakingFroze, subjectType []uint8, subject []*big.Int, by []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "Froze", subjectTypeRule, subjectRule, byRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingFroze)
				if err := _ZktoroStaking.contract.UnpackLog(event, "Froze", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Froze(uint8 indexed subjectType, uint256 indexed subject, address indexed by, bool isFrozen)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseFroze(log types.Log) (*ZktoroStakingFroze, error) {
	event := new(ZktoroStakingFroze)
	if err := _ZktoroStaking.contract.UnpackLog(event, "Froze", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingInitializedIterator is returned from FilterInitialized and is used to iterate over the raw logs and unpacked data for Initialized events raised by the ZktoroStaking contract.
type ZktoroStakingInitializedIterator struct {
	Event *ZktoroStakingInitialized // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingInitializedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingInitialized)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingInitializedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingInitializedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingInitialized represents a Initialized event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterInitialized(opts *bind.FilterOpts) (*ZktoroStakingInitializedIterator, error) {

	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingInitializedIterator{contract: _ZktoroStaking.contract, event: "Initialized", logs: logs, sub: sub}, nil
}

// WatchInitialized is a free log subscription operation binding the contract event 0x7f26b83ff96e1f2b6a682f133852f6798a09c465da95921460cefb3847402498.
//
// Solidity: event Initialized(uint8 version)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchInitialized(opts *bind.WatchOpts, sink chan<- *ZktoroStakingInitialized) (event.Subscription, error) {

	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "Initialized")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingInitialized)
				if err := _ZktoroStaking.contract.UnpackLog(event, "Initialized", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Initialized(uint8 version)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseInitialized(log types.Log) (*ZktoroStakingInitialized, error) {
	event := new(ZktoroStakingInitialized)
	if err := _ZktoroStaking.contract.UnpackLog(event, "Initialized", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingMaxStakeReachedIterator is returned from FilterMaxStakeReached and is used to iterate over the raw logs and unpacked data for MaxStakeReached events raised by the ZktoroStaking contract.
type ZktoroStakingMaxStakeReachedIterator struct {
	Event *ZktoroStakingMaxStakeReached // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingMaxStakeReachedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingMaxStakeReached)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingMaxStakeReachedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingMaxStakeReachedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingMaxStakeReached represents a MaxStakeReached event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterMaxStakeReached(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int) (*ZktoroStakingMaxStakeReachedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "MaxStakeReached", subjectTypeRule, subjectRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingMaxStakeReachedIterator{contract: _ZktoroStaking.contract, event: "MaxStakeReached", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event MaxStakeReached(uint8 indexed subjectType, uint256 indexed subject)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchMaxStakeReached(opts *bind.WatchOpts, sink chan<- *ZktoroStakingMaxStakeReached, subjectType []uint8, subject []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "MaxStakeReached", subjectTypeRule, subjectRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingMaxStakeReached)
				if err := _ZktoroStaking.contract.UnpackLog(event, "MaxStakeReached", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MaxStakeReached(uint8 indexed subjectType, uint256 indexed subject)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseMaxStakeReached(log types.Log) (*ZktoroStakingMaxStakeReached, error) {
	event := new(ZktoroStakingMaxStakeReached)
	if err := _ZktoroStaking.contract.UnpackLog(event, "MaxStakeReached", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingRouterUpdatedIterator is returned from FilterRouterUpdated and is used to iterate over the raw logs and unpacked data for RouterUpdated events raised by the ZktoroStaking contract.
type ZktoroStakingRouterUpdatedIterator struct {
	Event *ZktoroStakingRouterUpdated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingRouterUpdatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingRouterUpdated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingRouterUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingRouterUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingRouterUpdated represents a RouterUpdated event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterRouterUpdated(opts *bind.FilterOpts, router []common.Address) (*ZktoroStakingRouterUpdatedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "RouterUpdated", routerRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingRouterUpdatedIterator{contract: _ZktoroStaking.contract, event: "RouterUpdated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event RouterUpdated(address indexed router)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchRouterUpdated(opts *bind.WatchOpts, sink chan<- *ZktoroStakingRouterUpdated, router []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "RouterUpdated", routerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingRouterUpdated)
				if err := _ZktoroStaking.contract.UnpackLog(event, "RouterUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event RouterUpdated(address indexed router)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseRouterUpdated(log types.Log) (*ZktoroStakingRouterUpdated, error) {
	event := new(ZktoroStakingRouterUpdated)
	if err := _ZktoroStaking.contract.UnpackLog(event, "RouterUpdated", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingSlashDelegatorsPercentSetIterator is returned from FilterSlashDelegatorsPercentSet and is used to iterate over the raw logs and unpacked data for SlashDelegatorsPercentSet events raised by the ZktoroStaking contract.
type ZktoroStakingSlashDelegatorsPercentSetIterator struct {
	Event *ZktoroStakingSlashDelegatorsPercentSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingSlashDelegatorsPercentSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingSlashDelegatorsPercentSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingSlashDelegatorsPercentSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingSlashDelegatorsPercentSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingSlashDelegatorsPercentSet represents a SlashDelegatorsPercentSet event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterSlashDelegatorsPercentSet(opts *bind.FilterOpts) (*ZktoroStakingSlashDelegatorsPercentSetIterator, error) {

	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "SlashDelegatorsPercentSet")
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingSlashDelegatorsPercentSetIterator{contract: _ZktoroStaking.contract, event: "SlashDelegatorsPercentSet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SlashDelegatorsPercentSet(uint256 percent)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchSlashDelegatorsPercentSet(opts *bind.WatchOpts, sink chan<- *ZktoroStakingSlashDelegatorsPercentSet) (event.Subscription, error) {

	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "SlashDelegatorsPercentSet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingSlashDelegatorsPercentSet)
				if err := _ZktoroStaking.contract.UnpackLog(event, "SlashDelegatorsPercentSet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SlashDelegatorsPercentSet(uint256 percent)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseSlashDelegatorsPercentSet(log types.Log) (*ZktoroStakingSlashDelegatorsPercentSet, error) {
	event := new(ZktoroStakingSlashDelegatorsPercentSet)
	if err := _ZktoroStaking.contract.UnpackLog(event, "SlashDelegatorsPercentSet", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingSlashedIterator is returned from FilterSlashed and is used to iterate over the raw logs and unpacked data for Slashed events raised by the ZktoroStaking contract.
type ZktoroStakingSlashedIterator struct {
	Event *ZktoroStakingSlashed // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingSlashedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingSlashed)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingSlashedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingSlashedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingSlashed represents a Slashed event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterSlashed(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, by []common.Address) (*ZktoroStakingSlashedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "Slashed", subjectTypeRule, subjectRule, byRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingSlashedIterator{contract: _ZktoroStaking.contract, event: "Slashed", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Slashed(uint8 indexed subjectType, uint256 indexed subject, address indexed by, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchSlashed(opts *bind.WatchOpts, sink chan<- *ZktoroStakingSlashed, subjectType []uint8, subject []*big.Int, by []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "Slashed", subjectTypeRule, subjectRule, byRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingSlashed)
				if err := _ZktoroStaking.contract.UnpackLog(event, "Slashed", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Slashed(uint8 indexed subjectType, uint256 indexed subject, address indexed by, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseSlashed(log types.Log) (*ZktoroStakingSlashed, error) {
	event := new(ZktoroStakingSlashed)
	if err := _ZktoroStaking.contract.UnpackLog(event, "Slashed", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingSlashedShareSentIterator is returned from FilterSlashedShareSent and is used to iterate over the raw logs and unpacked data for SlashedShareSent events raised by the ZktoroStaking contract.
type ZktoroStakingSlashedShareSentIterator struct {
	Event *ZktoroStakingSlashedShareSent // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingSlashedShareSentIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingSlashedShareSent)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingSlashedShareSentIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingSlashedShareSentIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingSlashedShareSent represents a SlashedShareSent event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterSlashedShareSent(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, by []common.Address) (*ZktoroStakingSlashedShareSentIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "SlashedShareSent", subjectTypeRule, subjectRule, byRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingSlashedShareSentIterator{contract: _ZktoroStaking.contract, event: "SlashedShareSent", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SlashedShareSent(uint8 indexed subjectType, uint256 indexed subject, address indexed by, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchSlashedShareSent(opts *bind.WatchOpts, sink chan<- *ZktoroStakingSlashedShareSent, subjectType []uint8, subject []*big.Int, by []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "SlashedShareSent", subjectTypeRule, subjectRule, byRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingSlashedShareSent)
				if err := _ZktoroStaking.contract.UnpackLog(event, "SlashedShareSent", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SlashedShareSent(uint8 indexed subjectType, uint256 indexed subject, address indexed by, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseSlashedShareSent(log types.Log) (*ZktoroStakingSlashedShareSent, error) {
	event := new(ZktoroStakingSlashedShareSent)
	if err := _ZktoroStaking.contract.UnpackLog(event, "SlashedShareSent", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingStakeDepositedIterator is returned from FilterStakeDeposited and is used to iterate over the raw logs and unpacked data for StakeDeposited events raised by the ZktoroStaking contract.
type ZktoroStakingStakeDepositedIterator struct {
	Event *ZktoroStakingStakeDeposited // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingStakeDepositedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingStakeDeposited)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingStakeDepositedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingStakeDepositedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingStakeDeposited represents a StakeDeposited event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterStakeDeposited(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, account []common.Address) (*ZktoroStakingStakeDepositedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "StakeDeposited", subjectTypeRule, subjectRule, accountRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingStakeDepositedIterator{contract: _ZktoroStaking.contract, event: "StakeDeposited", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StakeDeposited(uint8 indexed subjectType, uint256 indexed subject, address indexed account, uint256 amount)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchStakeDeposited(opts *bind.WatchOpts, sink chan<- *ZktoroStakingStakeDeposited, subjectType []uint8, subject []*big.Int, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "StakeDeposited", subjectTypeRule, subjectRule, accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingStakeDeposited)
				if err := _ZktoroStaking.contract.UnpackLog(event, "StakeDeposited", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event StakeDeposited(uint8 indexed subjectType, uint256 indexed subject, address indexed account, uint256 amount)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseStakeDeposited(log types.Log) (*ZktoroStakingStakeDeposited, error) {
	event := new(ZktoroStakingStakeDeposited)
	if err := _ZktoroStaking.contract.UnpackLog(event, "StakeDeposited", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingStakeHelpersConfiguredIterator is returned from FilterStakeHelpersConfigured and is used to iterate over the raw logs and unpacked data for StakeHelpersConfigured events raised by the ZktoroStaking contract.
type ZktoroStakingStakeHelpersConfiguredIterator struct {
	Event *ZktoroStakingStakeHelpersConfigured // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingStakeHelpersConfiguredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingStakeHelpersConfigured)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingStakeHelpersConfiguredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingStakeHelpersConfiguredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingStakeHelpersConfigured represents a StakeHelpersConfigured event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterStakeHelpersConfigured(opts *bind.FilterOpts, subjectGateway []common.Address, allocator []common.Address) (*ZktoroStakingStakeHelpersConfiguredIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "StakeHelpersConfigured", subjectGatewayRule, allocatorRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingStakeHelpersConfiguredIterator{contract: _ZktoroStaking.contract, event: "StakeHelpersConfigured", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StakeHelpersConfigured(address indexed subjectGateway, address indexed allocator)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchStakeHelpersConfigured(opts *bind.WatchOpts, sink chan<- *ZktoroStakingStakeHelpersConfigured, subjectGateway []common.Address, allocator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "StakeHelpersConfigured", subjectGatewayRule, allocatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingStakeHelpersConfigured)
				if err := _ZktoroStaking.contract.UnpackLog(event, "StakeHelpersConfigured", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event StakeHelpersConfigured(address indexed subjectGateway, address indexed allocator)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseStakeHelpersConfigured(log types.Log) (*ZktoroStakingStakeHelpersConfigured, error) {
	event := new(ZktoroStakingStakeHelpersConfigured)
	if err := _ZktoroStaking.contract.UnpackLog(event, "StakeHelpersConfigured", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingTokensSweptIterator is returned from FilterTokensSwept and is used to iterate over the raw logs and unpacked data for TokensSwept events raised by the ZktoroStaking contract.
type ZktoroStakingTokensSweptIterator struct {
	Event *ZktoroStakingTokensSwept // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingTokensSweptIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingTokensSwept)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingTokensSweptIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingTokensSweptIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingTokensSwept represents a TokensSwept event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterTokensSwept(opts *bind.FilterOpts, token []common.Address) (*ZktoroStakingTokensSweptIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "TokensSwept", tokenRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingTokensSweptIterator{contract: _ZktoroStaking.contract, event: "TokensSwept", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TokensSwept(address indexed token, address to, uint256 amount)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchTokensSwept(opts *bind.WatchOpts, sink chan<- *ZktoroStakingTokensSwept, token []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "TokensSwept", tokenRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingTokensSwept)
				if err := _ZktoroStaking.contract.UnpackLog(event, "TokensSwept", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TokensSwept(address indexed token, address to, uint256 amount)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseTokensSwept(log types.Log) (*ZktoroStakingTokensSwept, error) {
	event := new(ZktoroStakingTokensSwept)
	if err := _ZktoroStaking.contract.UnpackLog(event, "TokensSwept", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingTransferBatchIterator is returned from FilterTransferBatch and is used to iterate over the raw logs and unpacked data for TransferBatch events raised by the ZktoroStaking contract.
type ZktoroStakingTransferBatchIterator struct {
	Event *ZktoroStakingTransferBatch // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingTransferBatchIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingTransferBatch)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingTransferBatchIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingTransferBatchIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingTransferBatch represents a TransferBatch event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterTransferBatch(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*ZktoroStakingTransferBatchIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingTransferBatchIterator{contract: _ZktoroStaking.contract, event: "TransferBatch", logs: logs, sub: sub}, nil
}

// WatchTransferBatch is a free log subscription operation binding the contract event 0x4a39dc06d4c0dbc64b70af90fd698a233a518aa5d07e595d983b8c0526c8f7fb.
//
// Solidity: event TransferBatch(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] values)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchTransferBatch(opts *bind.WatchOpts, sink chan<- *ZktoroStakingTransferBatch, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingTransferBatch)
				if err := _ZktoroStaking.contract.UnpackLog(event, "TransferBatch", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TransferBatch(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] values)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseTransferBatch(log types.Log) (*ZktoroStakingTransferBatch, error) {
	event := new(ZktoroStakingTransferBatch)
	if err := _ZktoroStaking.contract.UnpackLog(event, "TransferBatch", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingTransferSingleIterator is returned from FilterTransferSingle and is used to iterate over the raw logs and unpacked data for TransferSingle events raised by the ZktoroStaking contract.
type ZktoroStakingTransferSingleIterator struct {
	Event *ZktoroStakingTransferSingle // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingTransferSingleIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingTransferSingle)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingTransferSingleIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingTransferSingleIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingTransferSingle represents a TransferSingle event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterTransferSingle(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*ZktoroStakingTransferSingleIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingTransferSingleIterator{contract: _ZktoroStaking.contract, event: "TransferSingle", logs: logs, sub: sub}, nil
}

// WatchTransferSingle is a free log subscription operation binding the contract event 0xc3d58168c5ae7397731d063d5bbf3d657854427343f4c083240f7aacaa2d0f62.
//
// Solidity: event TransferSingle(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchTransferSingle(opts *bind.WatchOpts, sink chan<- *ZktoroStakingTransferSingle, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingTransferSingle)
				if err := _ZktoroStaking.contract.UnpackLog(event, "TransferSingle", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TransferSingle(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseTransferSingle(log types.Log) (*ZktoroStakingTransferSingle, error) {
	event := new(ZktoroStakingTransferSingle)
	if err := _ZktoroStaking.contract.UnpackLog(event, "TransferSingle", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingTreasurySetIterator is returned from FilterTreasurySet and is used to iterate over the raw logs and unpacked data for TreasurySet events raised by the ZktoroStaking contract.
type ZktoroStakingTreasurySetIterator struct {
	Event *ZktoroStakingTreasurySet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingTreasurySetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingTreasurySet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingTreasurySetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingTreasurySetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingTreasurySet represents a TreasurySet event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterTreasurySet(opts *bind.FilterOpts) (*ZktoroStakingTreasurySetIterator, error) {

	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "TreasurySet")
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingTreasurySetIterator{contract: _ZktoroStaking.contract, event: "TreasurySet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event TreasurySet(address newTreasury)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchTreasurySet(opts *bind.WatchOpts, sink chan<- *ZktoroStakingTreasurySet) (event.Subscription, error) {

	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "TreasurySet")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingTreasurySet)
				if err := _ZktoroStaking.contract.UnpackLog(event, "TreasurySet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TreasurySet(address newTreasury)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseTreasurySet(log types.Log) (*ZktoroStakingTreasurySet, error) {
	event := new(ZktoroStakingTreasurySet)
	if err := _ZktoroStaking.contract.UnpackLog(event, "TreasurySet", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingURIIterator is returned from FilterURI and is used to iterate over the raw logs and unpacked data for URI events raised by the ZktoroStaking contract.
type ZktoroStakingURIIterator struct {
	Event *ZktoroStakingURI // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingURIIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingURIIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingURIIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingURI represents a URI event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterURI(opts *bind.FilterOpts, id []*big.Int) (*ZktoroStakingURIIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingURIIterator{contract: _ZktoroStaking.contract, event: "URI", logs: logs, sub: sub}, nil
}

// WatchURI is a free log subscription operation binding the contract event 0x6bb7ff708619ba0610cba295a58592e0451dee2622938c8755667688daf3529b.
//
// Solidity: event URI(string value, uint256 indexed id)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchURI(opts *bind.WatchOpts, sink chan<- *ZktoroStakingURI, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingURI)
				if err := _ZktoroStaking.contract.UnpackLog(event, "URI", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event URI(string value, uint256 indexed id)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseURI(log types.Log) (*ZktoroStakingURI, error) {
	event := new(ZktoroStakingURI)
	if err := _ZktoroStaking.contract.UnpackLog(event, "URI", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingUpgradedIterator is returned from FilterUpgraded and is used to iterate over the raw logs and unpacked data for Upgraded events raised by the ZktoroStaking contract.
type ZktoroStakingUpgradedIterator struct {
	Event *ZktoroStakingUpgraded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingUpgradedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingUpgraded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingUpgradedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingUpgradedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingUpgraded represents a Upgraded event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterUpgraded(opts *bind.FilterOpts, implementation []common.Address) (*ZktoroStakingUpgradedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "Upgraded", implementationRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingUpgradedIterator{contract: _ZktoroStaking.contract, event: "Upgraded", logs: logs, sub: sub}, nil
}

// WatchUpgraded is a free log subscription operation binding the contract event 0xbc7cd75a20ee27fd9adebab32041f755214dbc6bffa90cc0225b39da2e5c2d3b.
//
// Solidity: event Upgraded(address indexed implementation)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchUpgraded(opts *bind.WatchOpts, sink chan<- *ZktoroStakingUpgraded, implementation []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "Upgraded", implementationRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingUpgraded)
				if err := _ZktoroStaking.contract.UnpackLog(event, "Upgraded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Upgraded(address indexed implementation)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseUpgraded(log types.Log) (*ZktoroStakingUpgraded, error) {
	event := new(ZktoroStakingUpgraded)
	if err := _ZktoroStaking.contract.UnpackLog(event, "Upgraded", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingWithdrawalExecutedIterator is returned from FilterWithdrawalExecuted and is used to iterate over the raw logs and unpacked data for WithdrawalExecuted events raised by the ZktoroStaking contract.
type ZktoroStakingWithdrawalExecutedIterator struct {
	Event *ZktoroStakingWithdrawalExecuted // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingWithdrawalExecutedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingWithdrawalExecuted)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingWithdrawalExecutedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingWithdrawalExecutedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingWithdrawalExecuted represents a WithdrawalExecuted event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterWithdrawalExecuted(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, account []common.Address) (*ZktoroStakingWithdrawalExecutedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "WithdrawalExecuted", subjectTypeRule, subjectRule, accountRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingWithdrawalExecutedIterator{contract: _ZktoroStaking.contract, event: "WithdrawalExecuted", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WithdrawalExecuted(uint8 indexed subjectType, uint256 indexed subject, address indexed account)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchWithdrawalExecuted(opts *bind.WatchOpts, sink chan<- *ZktoroStakingWithdrawalExecuted, subjectType []uint8, subject []*big.Int, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "WithdrawalExecuted", subjectTypeRule, subjectRule, accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingWithdrawalExecuted)
				if err := _ZktoroStaking.contract.UnpackLog(event, "WithdrawalExecuted", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event WithdrawalExecuted(uint8 indexed subjectType, uint256 indexed subject, address indexed account)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseWithdrawalExecuted(log types.Log) (*ZktoroStakingWithdrawalExecuted, error) {
	event := new(ZktoroStakingWithdrawalExecuted)
	if err := _ZktoroStaking.contract.UnpackLog(event, "WithdrawalExecuted", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingWithdrawalInitiatedIterator is returned from FilterWithdrawalInitiated and is used to iterate over the raw logs and unpacked data for WithdrawalInitiated events raised by the ZktoroStaking contract.
type ZktoroStakingWithdrawalInitiatedIterator struct {
	Event *ZktoroStakingWithdrawalInitiated // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingWithdrawalInitiatedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingWithdrawalInitiated)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingWithdrawalInitiatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingWithdrawalInitiatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingWithdrawalInitiated represents a WithdrawalInitiated event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterWithdrawalInitiated(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, account []common.Address) (*ZktoroStakingWithdrawalInitiatedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "WithdrawalInitiated", subjectTypeRule, subjectRule, accountRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingWithdrawalInitiatedIterator{contract: _ZktoroStaking.contract, event: "WithdrawalInitiated", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event WithdrawalInitiated(uint8 indexed subjectType, uint256 indexed subject, address indexed account, uint64 deadline)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchWithdrawalInitiated(opts *bind.WatchOpts, sink chan<- *ZktoroStakingWithdrawalInitiated, subjectType []uint8, subject []*big.Int, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "WithdrawalInitiated", subjectTypeRule, subjectRule, accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingWithdrawalInitiated)
				if err := _ZktoroStaking.contract.UnpackLog(event, "WithdrawalInitiated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event WithdrawalInitiated(uint8 indexed subjectType, uint256 indexed subject, address indexed account, uint64 deadline)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseWithdrawalInitiated(log types.Log) (*ZktoroStakingWithdrawalInitiated, error) {
	event := new(ZktoroStakingWithdrawalInitiated)
	if err := _ZktoroStaking.contract.UnpackLog(event, "WithdrawalInitiated", log); err != nil {
		return nil, err
	}
