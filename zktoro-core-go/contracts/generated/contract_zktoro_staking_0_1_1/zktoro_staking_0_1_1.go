...
package contract_zktoro_staking_0_1_1
...
func DeployZktoroStaking(auth *bind.TransactOpts, backend bind.ContractBackend, forwarder common.Address) (common.Address, *types.Transaction, *ZktoroStaking, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(ZktoroStakingBin), backend, forwarder)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
func (_ZktoroStaking *ZktoroStakingCaller) AvailableReward(opts *bind.CallOpts, subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	var out []interface{}
	err := _ZktoroStaking.contract.Call(opts, &out, "availableReward", subjectType, subject, account)
...
//
// Solidity: function availableReward(uint8 subjectType, uint256 subject, address account) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) AvailableReward(subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	return _ZktoroStaking.Contract.AvailableReward(&_ZktoroStaking.CallOpts, subjectType, subject, account)
}

// AvailableReward is a free data retrieval call binding the contract method 0x8c5588ac.
//
// Solidity: function availableReward(uint8 subjectType, uint256 subject, address account) view returns(uint256)
func (_ZktoroStaking *ZktoroStakingCallerSession) AvailableReward(subjectType uint8, subject *big.Int, account common.Address) (*big.Int, error) {
	return _ZktoroStaking.Contract.AvailableReward(&_ZktoroStaking.CallOpts, subjectType, subject, account)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Initialize(opts *bind.TransactOpts, __manager common.Address, __router common.Address, __stakedToken common.Address, __withdrawalDelay uint64, __treasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "initialize", __manager, __router, __stakedToken, __withdrawalDelay, __treasury)
}

// Initialize is a paid mutator transaction binding the contract method 0x8432d6b6.
//
// Solidity: function initialize(address __manager, address __router, address __stakedToken, uint64 __withdrawalDelay, address __treasury) returns()
func (_ZktoroStaking *ZktoroStakingSession) Initialize(__manager common.Address, __router common.Address, __stakedToken common.Address, __withdrawalDelay uint64, __treasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Initialize(&_ZktoroStaking.TransactOpts, __manager, __router, __stakedToken, __withdrawalDelay, __treasury)
}

// Initialize is a paid mutator transaction binding the contract method 0x8432d6b6.
//
// Solidity: function initialize(address __manager, address __router, address __stakedToken, uint64 __withdrawalDelay, address __treasury) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) Initialize(__manager common.Address, __router common.Address, __stakedToken common.Address, __withdrawalDelay uint64, __treasury common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Initialize(&_ZktoroStaking.TransactOpts, __manager, __router, __stakedToken, __withdrawalDelay, __treasury)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) ReleaseReward(opts *bind.TransactOpts, subjectType uint8, subject *big.Int, account common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "releaseReward", subjectType, subject, account)
}

// ReleaseReward is a paid mutator transaction binding the contract method 0xd1e59d1c.
//
// Solidity: function releaseReward(uint8 subjectType, uint256 subject, address account) returns(uint256)
func (_ZktoroStaking *ZktoroStakingSession) ReleaseReward(subjectType uint8, subject *big.Int, account common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.ReleaseReward(&_ZktoroStaking.TransactOpts, subjectType, subject, account)
}

// ReleaseReward is a paid mutator transaction binding the contract method 0xd1e59d1c.
//
// Solidity: function releaseReward(uint8 subjectType, uint256 subject, address account) returns(uint256)
func (_ZktoroStaking *ZktoroStakingTransactorSession) ReleaseReward(subjectType uint8, subject *big.Int, account common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.ReleaseReward(&_ZktoroStaking.TransactOpts, subjectType, subject, account)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) Reward(opts *bind.TransactOpts, subjectType uint8, subject *big.Int, value *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "reward", subjectType, subject, value)
}

// Reward is a paid mutator transaction binding the contract method 0x75eb81d6.
//
// Solidity: function reward(uint8 subjectType, uint256 subject, uint256 value) returns()
func (_ZktoroStaking *ZktoroStakingSession) Reward(subjectType uint8, subject *big.Int, value *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Reward(&_ZktoroStaking.TransactOpts, subjectType, subject, value)
}

// Reward is a paid mutator transaction binding the contract method 0x75eb81d6.
//
// Solidity: function reward(uint8 subjectType, uint256 subject, uint256 value) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) Reward(subjectType uint8, subject *big.Int, value *big.Int) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.Reward(&_ZktoroStaking.TransactOpts, subjectType, subject, value)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetRouter(opts *bind.TransactOpts, newRouter common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setRouter", newRouter)
}

// SetRouter is a paid mutator transaction binding the contract method 0xc0d78655.
//
// Solidity: function setRouter(address newRouter) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetRouter(newRouter common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetRouter(&_ZktoroStaking.TransactOpts, newRouter)
}

// SetRouter is a paid mutator transaction binding the contract method 0xc0d78655.
//
// Solidity: function setRouter(address newRouter) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetRouter(newRouter common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetRouter(&_ZktoroStaking.TransactOpts, newRouter)
}
...
func (_ZktoroStaking *ZktoroStakingTransactor) SetStakingParametersManager(opts *bind.TransactOpts, newStakingParameters common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.contract.Transact(opts, "setStakingParametersManager", newStakingParameters)
}

// SetStakingParametersManager is a paid mutator transaction binding the contract method 0x0a615413.
//
// Solidity: function setStakingParametersManager(address newStakingParameters) returns()
func (_ZktoroStaking *ZktoroStakingSession) SetStakingParametersManager(newStakingParameters common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetStakingParametersManager(&_ZktoroStaking.TransactOpts, newStakingParameters)
}

// SetStakingParametersManager is a paid mutator transaction binding the contract method 0x0a615413.
//
// Solidity: function setStakingParametersManager(address newStakingParameters) returns()
func (_ZktoroStaking *ZktoroStakingTransactorSession) SetStakingParametersManager(newStakingParameters common.Address) (*types.Transaction, error) {
	return _ZktoroStaking.Contract.SetStakingParametersManager(&_ZktoroStaking.TransactOpts, newStakingParameters)
}
...
// ZktoroStakingReleasedIterator is returned from FilterReleased and is used to iterate over the raw logs and unpacked data for Released events raised by the ZktoroStaking contract.
type ZktoroStakingReleasedIterator struct {
	Event *ZktoroStakingReleased // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingReleasedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingReleased)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingReleasedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingReleasedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingReleased represents a Released event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterReleased(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, to []common.Address) (*ZktoroStakingReleasedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "Released", subjectTypeRule, subjectRule, toRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingReleasedIterator{contract: _ZktoroStaking.contract, event: "Released", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Released(uint8 indexed subjectType, uint256 indexed subject, address indexed to, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchReleased(opts *bind.WatchOpts, sink chan<- *ZktoroStakingReleased, subjectType []uint8, subject []*big.Int, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "Released", subjectTypeRule, subjectRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingReleased)
				if err := _ZktoroStaking.contract.UnpackLog(event, "Released", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Released(uint8 indexed subjectType, uint256 indexed subject, address indexed to, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseReleased(log types.Log) (*ZktoroStakingReleased, error) {
	event := new(ZktoroStakingReleased)
	if err := _ZktoroStaking.contract.UnpackLog(event, "Released", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingRewardedIterator is returned from FilterRewarded and is used to iterate over the raw logs and unpacked data for Rewarded events raised by the ZktoroStaking contract.
type ZktoroStakingRewardedIterator struct {
	Event *ZktoroStakingRewarded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingRewardedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingRewarded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingRewardedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingRewardedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingRewarded represents a Rewarded event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterRewarded(opts *bind.FilterOpts, subjectType []uint8, subject []*big.Int, from []common.Address) (*ZktoroStakingRewardedIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "Rewarded", subjectTypeRule, subjectRule, fromRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingRewardedIterator{contract: _ZktoroStaking.contract, event: "Rewarded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Rewarded(uint8 indexed subjectType, uint256 indexed subject, address indexed from, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchRewarded(opts *bind.WatchOpts, sink chan<- *ZktoroStakingRewarded, subjectType []uint8, subject []*big.Int, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "Rewarded", subjectTypeRule, subjectRule, fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingRewarded)
				if err := _ZktoroStaking.contract.UnpackLog(event, "Rewarded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Rewarded(uint8 indexed subjectType, uint256 indexed subject, address indexed from, uint256 value)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseRewarded(log types.Log) (*ZktoroStakingRewarded, error) {
	event := new(ZktoroStakingRewarded)
	if err := _ZktoroStaking.contract.UnpackLog(event, "Rewarded", log); err != nil {
		return nil, err
	}
...
// ZktoroStakingStakeParamsManagerSetIterator is returned from FilterStakeParamsManagerSet and is used to iterate over the raw logs and unpacked data for StakeParamsManagerSet events raised by the ZktoroStaking contract.
type ZktoroStakingStakeParamsManagerSetIterator struct {
	Event *ZktoroStakingStakeParamsManagerSet // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ZktoroStakingStakeParamsManagerSetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZktoroStakingStakeParamsManagerSet)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ZktoroStakingStakeParamsManagerSetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ZktoroStakingStakeParamsManagerSetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ZktoroStakingStakeParamsManagerSet represents a StakeParamsManagerSet event raised by the ZktoroStaking contract.
...
func (_ZktoroStaking *ZktoroStakingFilterer) FilterStakeParamsManagerSet(opts *bind.FilterOpts, newManager []common.Address) (*ZktoroStakingStakeParamsManagerSetIterator, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.FilterLogs(opts, "StakeParamsManagerSet", newManagerRule)
	if err != nil {
		return nil, err
	}
	return &ZktoroStakingStakeParamsManagerSetIterator{contract: _ZktoroStaking.contract, event: "StakeParamsManagerSet", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event StakeParamsManagerSet(address indexed newManager)
func (_ZktoroStaking *ZktoroStakingFilterer) WatchStakeParamsManagerSet(opts *bind.WatchOpts, sink chan<- *ZktoroStakingStakeParamsManagerSet, newManager []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _ZktoroStaking.contract.WatchLogs(opts, "StakeParamsManagerSet", newManagerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZktoroStakingStakeParamsManagerSet)
				if err := _ZktoroStaking.contract.UnpackLog(event, "StakeParamsManagerSet", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event StakeParamsManagerSet(address indexed newManager)
func (_ZktoroStaking *ZktoroStakingFilterer) ParseStakeParamsManagerSet(log types.Log) (*ZktoroStakingStakeParamsManagerSet, error) {
	event := new(ZktoroStakingStakeParamsManagerSet)
	if err := _ZktoroStaking.contract.UnpackLog(event, "StakeParamsManagerSet", log); err != nil {
		return nil, err
	}
