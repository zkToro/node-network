...
func TransferSharesMessageFromSingle(l types.Log, evt *contract_zktoro_staking.ZktoroStakingTransferSingle, blk *domain.Block) (*TransferSharesMessage, error) {
...
func TransferSharesMessagesFromBatch(l types.Log, evt *contract_zktoro_staking.ZktoroStakingTransferBatch, blk *domain.Block) ([]*TransferSharesMessage, error) {
