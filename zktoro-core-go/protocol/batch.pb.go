...
type SignedPayload struct {
	...
	Type      SignedPayload_PayloadType `protobuf:"varint,1,opt,name=type,proto3,enum=network.zktoro.SignedPayload_PayloadType" json:"type,omitempty"`
...
type AlertBatch struct {
	...
	MaxSeverity       Finding_Severity           `protobuf:"varint,5,opt,name=maxSeverity,proto3,enum=network.zktoro.Finding_Severity" json:"maxSeverity,omitempty"`
...
var file_batch_proto_goTypes = []interface{}{
	(SignedPayload_PayloadType)(0),  // 0: network.zktoro.SignedPayload.PayloadType
	(*BatchSummary)(nil),            // 1: network.zktoro.BatchSummary
	(*BatchReceipt)(nil),            // 2: network.zktoro.BatchReceipt
	(*SignedPayload)(nil),           // 3: network.zktoro.SignedPayload
	(*AlertBatch)(nil),              // 4: network.zktoro.AlertBatch
	(*BlockResults)(nil),            // 5: network.zktoro.BlockResults
	(*TransactionResults)(nil),      // 6: network.zktoro.TransactionResults
	(*CombinationAlertResults)(nil), // 7: network.zktoro.CombinationAlertResults
	(*AgentAlerts)(nil),             // 8: network.zktoro.AgentAlerts
	(*Block)(nil),                   // 9: network.zktoro.Block
	(*BatchAgent)(nil),              // 10: network.zktoro.BatchAgent
	(*ScannerVersion)(nil),          // 11: network.zktoro.ScannerVersion
	(*InspectionResults)(nil),       // 12: network.zktoro.InspectionResults
	(*InspectionInputs)(nil),        // 13: network.zktoro.InspectionInputs
	nil,                             // 14: network.zktoro.InspectionResults.MetadataEntry
	nil,                             // 15: network.zktoro.InspectionResults.IndicatorsEntry
	(*Provider)(nil),                // 16: network.zktoro.Provider
	(*Signature)(nil),               // 17: network.zktoro.Signature
	(Finding_Severity)(0),           // 18: network.zktoro.Finding.Severity
	(*AgentMetrics)(nil),            // 19: network.zktoro.AgentMetrics
	(*TransactionEvent)(nil),        // 20: network.zktoro.TransactionEvent
	(*AlertEvent)(nil),              // 21: network.zktoro.AlertEvent
	(*SignedAlert)(nil),             // 22: network.zktoro.SignedAlert
	(*AgentInfo)(nil),               // 23: network.zktoro.AgentInfo
}
var file_batch_proto_depIdxs = []int32{
	11, // 0: network.zktoro.BatchSummary.scannerVersion:type_name -> network.zktoro.ScannerVersion
	12, // 1: network.zktoro.BatchSummary.inspectionResults:type_name -> network.zktoro.InspectionResults
	16, // 2: network.zktoro.BatchSummary.provider:type_name -> network.zktoro.Provider
	3,  // 3: network.zktoro.BatchReceipt.batchSummary:type_name -> network.zktoro.SignedPayload
	0,  // 4: network.zktoro.SignedPayload.type:type_name -> network.zktoro.SignedPayload.PayloadType
	17, // 5: network.zktoro.SignedPayload.signature:type_name -> network.zktoro.Signature
	18, // 6: network.zktoro.AlertBatch.maxSeverity:type_name -> network.zktoro.Finding.Severity
	5,  // 7: network.zktoro.AlertBatch.results:type_name -> network.zktoro.BlockResults
	10, // 8: network.zktoro.AlertBatch.agents:type_name -> network.zktoro.BatchAgent
	19, // 9: network.zktoro.AlertBatch.metrics:type_name -> network.zktoro.AgentMetrics
	11, // 10: network.zktoro.AlertBatch.scannerVersion:type_name -> network.zktoro.ScannerVersion
	8,  // 11: network.zktoro.AlertBatch.privateAlerts:type_name -> network.zktoro.AgentAlerts
	12, // 12: network.zktoro.AlertBatch.inspectionResults:type_name -> network.zktoro.InspectionResults
	7,  // 13: network.zktoro.AlertBatch.combinationAlerts:type_name -> network.zktoro.CombinationAlertResults
	16, // 14: network.zktoro.AlertBatch.provider:type_name -> network.zktoro.Provider
	9,  // 15: network.zktoro.BlockResults.block:type_name -> network.zktoro.Block
	8,  // 16: network.zktoro.BlockResults.results:type_name -> network.zktoro.AgentAlerts
	6,  // 17: network.zktoro.BlockResults.transactions:type_name -> network.zktoro.TransactionResults
	20, // 18: network.zktoro.TransactionResults.transaction:type_name -> network.zktoro.TransactionEvent
	8,  // 19: network.zktoro.TransactionResults.results:type_name -> network.zktoro.AgentAlerts
	21, // 20: network.zktoro.CombinationAlertResults.alertEvent:type_name -> network.zktoro.AlertEvent
	8,  // 21: network.zktoro.CombinationAlertResults.results:type_name -> network.zktoro.AgentAlerts
	22, // 22: network.zktoro.AgentAlerts.alerts:type_name -> network.zktoro.SignedAlert
	23, // 23: network.zktoro.BatchAgent.info:type_name -> network.zktoro.AgentInfo
	13, // 24: network.zktoro.InspectionResults.inputs:type_name -> network.zktoro.InspectionInputs
	14, // 25: network.zktoro.InspectionResults.metadata:type_name -> network.zktoro.InspectionResults.MetadataEntry
	15, // 26: network.zktoro.InspectionResults.indicators:type_name -> network.zktoro.InspectionResults.IndicatorsEntry
