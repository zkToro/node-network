...
type PublicAPIProxyConfig struct {
	Url             string            `yaml:"url" json:"url" validate:"omitempty,url" default:"https://api.zktoro.network"`
...
type ScannerConfig struct {
	...
	AlertAPIURL          string        `yaml:"apiUrl" json:"apiUrl" default:"https://api.zktoro.network/graphql" validate:"url"`
}
...
type RegistryConfig struct {
	ChainID                uint64        `yaml:"chainId" json:"chainId" default:"31337"`
	JsonRpc                JsonRpcConfig `yaml:"jsonRpc" json:"jsonRpc" default:"{\"url\": \"http://127.0.0.1:8545\"}"`
	IPFS                   IPFSConfig    `yaml:"ipfs" json:"ipfs"`
	ContainerRegistry      string        `yaml:"containerRegistry" json:"containerRegistry" validate:"hostname|hostname_port" default:"disco.zktoro.network" `
	...
	ReleaseDistributionUrl string        `yaml:"releaseDistributionUrl" json:"releaseDistributionUrl" default:"https://dist.zktoro.network/manifests/releases"`
}

type IPFSConfig struct {
	GatewayURL string `yaml:"gatewayUrl" json:"gatewayUrl" validate:"url" default:"https://ipfs.zktoro.network" `
	APIURL     string `yaml:"apiUrl" json:"apiUrl" validate:"url" default:"https://ipfs.zktoro.network" `
	Username   string `yaml:"username" json:"username"`
	Password   string `yaml:"password" json:"password"`
}
...
type PublisherConfig struct {
	...
	APIURL        string      `yaml:"apiUrl" json:"apiUrl" default:"https://alerts.zktoro.network" validate:"url"`
...
type ENSConfig struct {
	...
	ContractAddress string `yaml:"contractAddress" json:"contractAddress" validate:"omitempty,eth_addr" default:""`
	Override        bool   `yaml:"override" json:"override" default:"false"`
}

type TelemetryConfig struct {
	URL       string `yaml:"url" json:"url" default:"https://alerts.zktoro.network/telemetry" validate:"url"`
...
type AgentLogsConfig struct {
	URL                 string `yaml:"url" json:"url" default:"https://alerts.zktoro.network/logs/agents" validate:"url"`
	Disable             bool   `yaml:"disable" json:"disable"`
...
type StorageConfig struct {
	Provide string `yaml:"provide" json:"provide" default:"https://ipfs-router.zktoro.network/provide"`
	Reframe string `yaml:"reframe" json:"reframe" default:"https://ipfs-router.zktoro.network/reframe"`
}

type CombinerConfig struct {
	AlertAPIURL       string `yaml:"alertApiUrl" json:"alertApiUrl" default:"http://zktoro-public-api:8535" validate:"url"`
...
func (cfg *Config) ConfigFilePath() string {
	return path.Join(cfg.ZktoroDir, DefaultConfigFileName)
}

// GetConfigForContainer is how a container gets the zktoro configuration (file or env var)
...
func applyContextDefaults(cfg *Config) {
	...
	cfg.ZktoroDir = DefaultContainerzktoroDirPath
	cfg.KeyDirPath = path.Join(cfg.ZktoroDir, DefaultKeysDirName)
	cfg.CombinerConfig.CombinerCachePath = path.Join(cfg.ZktoroDir, DefaultCombinerCacheFileName)
}
...
func getConfigFromFile() (cfg Config, err error) {
	...
	case 2:
		err = errors.New("multiple config files found in the zktoro dir - please use only one of them")
		return
